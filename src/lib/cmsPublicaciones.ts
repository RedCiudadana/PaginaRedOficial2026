...
const publicationMarkdown = import.meta.glob('../cms/publicaciones/*.md', { as: 'raw', eager: true });

const publications: Publication[] = Object.entries(publicationMarkdown).map(([path, raw]) => {
...
export function getAllPublicaciones(): Publication[] {
  return publications;
}
