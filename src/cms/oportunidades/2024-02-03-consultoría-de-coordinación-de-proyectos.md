...
Objetivo general: Coordinacion de proyectos para Red Ciudadana. Esta consultoría es esencial para fortalecer la capacidad de Red Ciudadana para liderar y ejecutar proyectos que promuevan su misión, aumentando su impacto y eficacia en la consecución de objetivos sociales significativos.

* Objetivo específico No.1: Asegurar la implementación exitosa y oportuna de proyectos alineados con la misión y estrategia de Red Ciudadana.
* Objetivo específico No.2: Optimizar la asignación y utilización de recursos para maximizar el impacto y la eficiencia de los proyectos.
* Objetivo específico No.3: Fortalecer la capacidad de la organización para diseñar propuestas de proyectos competitivas y asegurar su financiamiento sostenible.
* Objetivo específico No.4: Mejorar la comunicación y reporte de avances y resultados, tanto internamente como hacia los financiadores y partes interesadas.

**ALCANCES DE LA CONSULTORÍA**

* La consultoría abarcará la coordinación general de proyectos desde su diseño inicial hasta la ejecución y cierre, incluyendo la búsqueda de financiamiento, supervisión de equipos, monitoreo y evaluación de proyectos. Incluye la gestión de múltiples proyectos simultáneamente, cada uno en diferentes etapas de desarrollo, y la interacción con un amplio rango de partes interesadas, tanto internas como externas.

**Actividades a realizar**

* Diseñar y desarrollar propuestas de proyectos, incluyendo la identificación de oportunidades de financiamiento.
* Coordinar y liderar equipos de proyectos, proporcionando orientación y apoyo para asegurar la calidad y el cumplimiento de los objetivos.
* Monitorizar el progreso de los proyectos, identificando y gestionando riesgos, y realizando ajustes según sea necesario.
* Preparar y presentar informes periódicos sobre el estado, avances y resultados de los proyectos a la dirección ejecutiva y a los financiadores.
* Gestionar eficientemente los recursos asignados a los proyectos, incluyendo presupuestos, personal y materiales.

**Productos**

* Propuestas de proyectos desarrolladas y presentadas, incluyendo planes de financiamiento.
* Planes de trabajo detallados para cada proyecto, incluyendo cronogramas y asignaciones de recursos.
* Informes periódicos de progreso y evaluaciones finales de los proyectos.
* Documentación de lecciones aprendidas y mejores prácticas identificadas durante la ejecución de los proyectos.



**PERFIL REQUERIDO**

* Educación: Titulación universitaria en Gestión de Proyectos, Desarrollo, Ciencias Sociales o áreas relacionadas.
* Experiencia: Mínimo 3 años de experiencia en coordinación y gestión de proyectos, preferentemente en el sector social o de desarrollo.
* Habilidades y Competencias: Fuertes habilidades analíticas y de resolución de problemas. Excelente capacidad de liderazgo y habilidades interpersonales. Competencia en la gestión de recursos y en la elaboración de informes. Capacidad para trabajar bajo presión y adaptarse a cambios rápidos.
* Habilidades Personales: Alta capacidad analítica, organizativa y de planificación. Habilidades de comunicación efectiva y trabajo en equipo.
