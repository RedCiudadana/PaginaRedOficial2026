      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 sm:mt-8 lg:mt-16 text-center">
          <div className="bg-white rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-sm lg:text-base text-gray-600 mb-4 lg:mb-6 max-w-2xl mx-auto px-4">
              Nuestro equipo está disponible para apoyarte con herramientas personalizadas y capacitaciones especializadas.
            </p>
            <Link
              to="/contacto"
              className="inline-block bg-black hover:bg-gray-800 text-white px-4 py-2 lg:px-8 lg:py-3 rounded-lg font-medium transition-colors duration-300 text-sm lg:text-base"
            >
