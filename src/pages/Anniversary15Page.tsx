...
import Banner03 from '../assets/banner/BANNER_03.png';
...
const Anniversary15Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white text-gray-900 px-6 py-2 rounded-full font-bold text-lg mb-8">
              <Award size={24} />
              <span>Celebrando 15 Años</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              15 Años Transformando Guatemala
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="bg-white text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-white transition-all transform hover:scale-105 shadow-lg">
      ...
      {/* Future Vision */}
      <div className="py-20 bg-primary to-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
